...
var ajaxList2 = function(queryURL2) {
    $.ajax({
        ...
        .done(function(response) {
            ...
            if (dropDownDrink === 'American Pale Ale') {
                $(".modal-body").html("<iframe width='420' height='315'src='http://www.youtube.com/embed/ZCy1cXeHDTQ'>" + "</iframe>");
            } else if (dropDownDrink === 'Dark Beer') {
                $(".modal-body").html("<iframe width='420' height='315'src='http://www.youtube.com/embed/SrPi4y9lOmc'>" + "</iframe>");
            } else if (dropDownDrink === 'Hefeweizen') {
                $(".modal-body").html("<iframe width='420' height='315'src='http://www.youtube.com/embed/EPfCTNiEggc'>" + "</iframe>");
            } else if (dropDownDrink === 'Irish Red') {
                $(".modal-body").html("<iframe width='420' height='315'src='http://www.youtube.com/embed/sTkwdIq7KSw'>" + "</iframe>");
            } else {
                return false;
            }
